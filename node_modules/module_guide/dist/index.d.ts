...
declare module "module_guide" {
    ...
    export class GuideDataHelper extends Subdata {
        onGuideChangeAction: Type.Action;
...
declare module "module_guide" {
    ...
    export class GuideModuleC extends ModuleC<GuideModuleS, GuideDataHelper> {
         ...
         * 阶段完成广播
         */
        guideComplateAction: Type.Action1<number>;
        /**
         * 覆盖角色GameObject
         */
         ...
         */
        setGuideArrowPointerInfo(guid: string, scale: Vector, isEffect: boolean, showPointerCount: number): void;
        /**
         * 获取引导线地标生成间隔距离
         * @returns
         */
         ...
         */
        reSetCharGo(go: Core.GameObject): void;
        /**
         * 获取引导主角对象
         * @returns
         */
        getCharGo(): Promise<Core.GameObject>;
        /**
         * 初始化引导模块
         */
        private initGuide;
...
declare module "module_guide" {
     ...
     */
    export class GuideModuleUI_Generate extends UI.UIBehavior {
        mLeftMask: UI.StaleButton;
        mTopMask: UI.StaleButton;
        mButtomMask: UI.StaleButton;
        mRightMask: UI.StaleButton;
        mBtn: UI.StaleButton;
        mBtnHand: UI.Image;
        mTextHand: UI.TextBlock;
...
declare module "module_guide" {
    ...
    export class GuideModuleView extends GuideModuleUI_Generate {
         ...
         * @param callback 回调
         */
        setGuideArrowTargetPos(targetPos: Type.Vector, callback: () => boolean, drawType: number, bUpdateArrow: boolean): Promise<void>;
        /**
         * 锁定一个对象
         * @param target
         */
        lockMWUIWidget(target: UI.Widget, callback: () => void, tips?: string, isShowBtn?: boolean): void;
    }
}
...
declare module "module_guide" {
    ...
    export class GuideTaskStage {
         ...
         * @param condition 条件
         */
        static newGuideTaskStage(type: GuideState, condition: UI.Widget | Type.Vector | Array<() => boolean>, runFuncs?: Array<() => void>, uiConditionRes?: () => boolean): GuideTaskStage;
    }
    /**
     * 引导信息
     */
    export class GuideInfo {
        ...
        constructor(complateNotify: Type.Action1<number>);
        /**
         * 关联引导UI - 过滤按钮 - 自定义通过条件
         * @param widget
         * @param condition
         * @returns
         */
        addBindUIByCondition(widget: UI.Widget, condition: () => boolean): GuideInfo;
        /**
         ...
         * @returns
         */
        addBindUIAndTipsByCondition(widget: UI.Widget, tips: string, condition: () => boolean): GuideInfo;
        /**
         * 关联引导UI - 按顺序压入
         * @param widget
         * @returns
         */
        addBindUI(...widgets: UI.Widget[]): GuideInfo;
        /**
         * 关联引导UI 可以带Tips
         * @param widget
         * @param tips
         * @returns
         */
        addBindUIAndTips(widget: UI.Widget, tips: string): GuideInfo;
        /**
         * 关联引导UI - 按顺序压入 - 跟随UI刷新
         * @param widget
         * @returns
         */
        addBindUIAlawaysRefrash(...widgets: UI.Widget[]): GuideInfo;
        /**
         * 关联世界坐标 - 按顺序压入
         * @param poslist
         * @returns
         */
        addBindWorldPos(...poslist: Type.Vector[]): GuideInfo;
        /**
         ...
         * @returns
         */
        addBindWorldPosByCondition(poslist: Type.Vector, callback: () => boolean): GuideInfo;
        /**
         * 关联世界坐标 - 按顺序压入 - 寻路渲染方式
         * @param poslist 坐标列表
         * @returns
         */
        addBindWorldPos_Pointer(...poslist: Type.Vector[]): GuideInfo;
        /**
         ...
         * @returns
         */
        addBindWorldPosByCondition_Pointer(poslist: Type.Vector, callback: () => boolean): GuideInfo;
        /**
         * 添加一个引导完成条件 - 按顺序压入
         * @param condition
         * @returns
